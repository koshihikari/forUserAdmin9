...
jQuery(document).ready(function($){
	 ...
	 */
	MYNAMESPACE.namespace('modules.helper.ConcretePageManagerForSmartphone');
	MYNAMESPACE.modules.helper.ConcretePageManagerForSmartphone = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.modules.helper.ConcretePageManagerForSmartphone.prototype = {
		_isEnabled						: false
		,_instances						: {}
		,_libraryPageIds				: []
		...
		,initialize: function(instances) {
			var thisObj = this;
			console.log('ConcretePageManagerForSmartphone :: initialize');
		 ...
		 * @return	void
		 */
		,publish: function(recordId, isPublishStaticPage) {
			var thisObj = this;
			...
			// } else {
			var tmpElement = $('<div>').attr('id', 'tmp');
				displayAreaElement = $('<div>').attr('id', 'displayArea');
				spContentElement = $('<div>').attr('id', 'spContent');
			...
			thisObj._instances['RenderingManager'].render(recordId, isPublishStaticPage);
