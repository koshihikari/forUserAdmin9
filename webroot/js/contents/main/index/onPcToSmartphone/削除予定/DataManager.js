...
//$(function() {
	 ...
	 */
	MYNAMESPACE.namespace('modules.main.index.onPcToSmartphone.DataManager');
	MYNAMESPACE.modules.main.index.onPcToSmartphone.DataManager = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.modules.main.index.onPcToSmartphone.DataManager.prototype = {
		_isEnabled						: false
		,_prop							: {}
		,_residenceId					: []
