...
jQuery(document).ready(function($){
	 ...
	 */
	MYNAMESPACE.namespace('modules.main.index.onPcToSmartphone.ResidencePageManager');
	MYNAMESPACE.modules.main.index.onPcToSmartphone.ResidencePageManager = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.modules.main.index.onPcToSmartphone.ResidencePageManager.prototype = {
		_isEnabled						: false
		...
		,setEvent: function(isEnabled) {
			...
			var id = thisObj._instances['DataManager'].getResidenceId();
