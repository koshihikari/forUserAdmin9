	...
	MYNAMESPACE.modules.library_page.catalog.onPcToSmartphone.PageManager.prototype = {
		...
		,getPageListSource: function(data, prop) {
			...
			if (prop['isLibraryElementPage'] === false) {
				...
				retSource += '\
						<div class="btn-hole">\
							<a href="' + editUrl + '" class="btn btn-test btn-primary btn-page-edit"\
								data-placement="top" data-original-title="「' + data['Library_Page']['title'] + '」ページを編集します。">\
								<span><i data-icon=""></i>編集する</span>\
							</a>';
			retSource += '\
							<button class="btn btn-test btn-primary btn-page-duplicate btn-disable"\
								data-placement="top" data-original-title="「' + data['Library_Page']['title'] + '」ページを複製します。">\
								<span><i data-icon=""></i>複製する</span>\
							</button>\
							<button class="btn btn-test btn-danger btn-page-delete" data-record-id="' + data['Library_Page']['id'] + '"\
			...
			if (prop['isLibraryElementPage'] === false) {
				retSource += '\
							<div class="dropdownWrapper">\
								<button id="dropdown_' + data['Library_Page']['id'] + '" class="btn btn-test btn-primary btn-page-view dropdown-toggle btn-block" data-record-id="' + data['Library_Page']['id'] + '" \
									data-placement="top" data-original-title="プレビュー版：：「' + data['Library_Page']['title'] + '」ページを表示します。" \
							...
							<button class="btn btn-test btn-primary btn-page-publish btn-disablea" data-record-id="' + data['Library_Page']['id'] + '"\
								data-placement="bottom" data-original-title="「' + data['Library_Page']['title'] + '」ページを書きだします。">\
								<span><i data-icon=""></i>本番ページ書き出し</span>\
							</button><br />';
				// if (data['smartphoneConcretePages']['id'] !== null) {
				if (data['Library_Page']['source'] !== '') {
					retSource += '\
							<div class="dropdownWrapper">\
								<button id="dropdown_' + data['Library_Page']['id'] + '" class="btn btn-test btn-primary btn-page-view dropdown-toggle btn-block" data-record-id="' + data['Library_Page']['id'] + '" \
