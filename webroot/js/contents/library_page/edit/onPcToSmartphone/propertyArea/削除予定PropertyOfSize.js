							...
							<div class="contentWrapper">\
								<div class="control-group sizeWrapper">\
									<div class="controls">\
										<div class="group">\
											<div class="btn-hole">\
												<button type="button" class="btn btn-primary switchBtn autoWidthBtn' + (thisObj._currentVal['widthType'] === 'auto' ? ' active' : '') + '" data-item-name="autoWidthBtn" data-placement="bottom" data-original-title="幅を自動で設定します。"><span><i data-icon=""></i>幅を自動で指定</span></button>\
											</div>\
										</div>\
										<div class="group">\
											<div class="btn-hole">\
												<button type="button" class="btn btn-primary switchBtn percentWidthBtn' + (thisObj._currentVal['isPercentWidth'] === true ? ' active' : '') + '" data-item-name="percentWidthBtn" data-placement="bottom" data-original-title="幅を％で指定します。"><span><i data-icon=""></i>幅を%で指定</span></button>\
											</div>\
										...
										<div class="group">\
											<div class="btn-hole">\
												<button type="button" class="btn btn-primary switchBtn pixelWidthBtn' + (thisObj._currentVal['isPercentWidth'] !== true ? ' active' : '') + '" data-item-name="pixelWidthBtn" data-placement="bottom" data-original-title="幅をピクセルで指定します。"><span><i data-icon=""></i>幅をピクセルで指定</span></button>\
											</div>\
