...
_html2canvas.Util.Bounds = function getBounds (el) {
    ...
    if (el.getBoundingClientRect){
        ...
        console.log('');
        console.log('---------------');
        console.log('_html2canvas.Util.Bounds :: bigin');
        console.log('   clientRect.right = ' + clientRect.right);
        console.log('   clientRect.left = ' + clientRect.left);
        console.log('   bounds.width = ' + bounds.width);
        console.log('   bounds.height = ' + bounds.height);
        console.log('_html2canvas.Util.Bounds :: end');
        console.log('---------------');
        console.log('');
...
_html2canvas.Util.getCSS = function (el, attribute) {
    ...
    function toPX( attribute, val ) {
        console.log('_html2canvas.Util.toPX');
...
_html2canvas.Util.BackgroundPosition = function ( el, bounds, image ) {
    console.log('_html2canvas.Util.BackgroundPosition');
...
_html2canvas.Util.Extend = function (options, defaults) {
    console.log('_html2canvas.Util.Extend');
...
_html2canvas.Util.Children = function( elem ) {
    console.log('_html2canvas.Util.Children');
...
_html2canvas.Generate.parseGradient = function(css, bounds) {
    console.log('_html2canvas.Generate.parseGradient');
...
_html2canvas.Generate.Gradient = function(src, bounds) {
    ...
    console.log('');
    console.log('---------------');
    console.log('_html2canvas.Generate.Gradient :: bigin');
    console.log('   canvas.width = ' + canvas.width);
    console.log('   canvas.height = ' + canvas.height);
    console.log('_html2canvas.Generate.Gradient :: end');
    console.log('---------------');
    console.log('');
...
_html2canvas.Generate.ListAlpha = function(number) {
    console.log('_html2canvas.Generate.ListAlpha');
    var tmp = "",
    modulus;
...
_html2canvas.Generate.ListRoman = function(number) {
    console.log('_html2canvas.Generate.ListRoman');
...
_html2canvas.Parse = function ( images, options ) {
    console.log('_html2canvas.Parse');
    window.scroll(0,0);
    ...
    function docSize(){
    console.log('_html2canvas.docSize');
    ...
    console.log('_html2canvas.getCSSInt');
    ...
    console.log('_html2canvas.renderRect');
    ...
    console.log('_html2canvas.textTransform');
        switch(transform){
            case "lowercase":
    ...
    console.log('_html2canvas.trimText');
        return text.replace(/^\s*/g, "").replace(/\s*$/g, "");
    }

    function fontMetrics (font, fontSize) {
    console.log('_html2canvas.fontMetrics');
    ...
    console.log('_html2canvas.drawText');
    ...
    console.log('_html2canvas.renderText');
        var ctx = stack.ctx,
    ...
    console.log('_html2canvas.listPosition');
    ...
    console.log('_html2canvas.elementIndex');
        var i = -1,
        count = 1,
    ...
    console.log('_html2canvas.renderListItem');
    ...
    console.log('_html2canvas.loadImage');
        var img = images[src];
    ...
    console.log('_html2canvas.clipBounds');
    ...
    console.log('_html2canvas.renderBorders');
    ...
    console.log('_html2canvas.renderFormValue');
    ...
    console.log('_html2canvas.renderImage');
        ctx.drawImage(
            image,
            sx, //sx
            sy, //sy
    ...
    console.log('_html2canvas.renderBackgroundRepeat');
        var sourceX = 0,
        sourceY=0;
        if (elx-x>0){
            sourceX = elx-x;
    ...
    console.log('_html2canvas.renderBackgroundRepeatY');
    ...
    console.log('_html2canvas.renderBackgroundRepeatX');
    ...
    console.log('_html2canvas.renderBackground');
    ...
    console.log('_html2canvas.renderElement');
    ...
    console.log('_html2canvas.parseElement');
    ...
    */
    ...
    console.log('_html2canvas.parseDOM');
...
function h2czContext(zindex) {
    console.log('_html2canvas.h2czContext');
    return {
        zindex: zindex,
        children: []
    };
...
_html2canvas.Preload = function( options ) {
    console.log('_html2canvas.Preload');
    ...
    console.log('_html2canvas.isSameOrigin');
        link.href = url;
    ...
    function start(){
    console.log('_html2canvas.start');
    ...
    console.log('_html2canvas.proxyGetImage');
        var callback_name,
    ...
    console.log('_html2canvas.getImages');
    ...
    console.log('_html2canvas.setImageLoadHandlers');
        img.onload = function() {
    ...
    console.log('_html2canvas.cleanupDOM');
            var img, src;
    ...
    console.log('_html2canvas.renderingDone');
            if (timeoutTimer) {
...
function h2cRenderContext(width, height) {
    console.log('_html2canvas.h2cRenderContext');
    var storage = [];
    return {
        storage: storage,
        width: width,
...
_html2canvas.Renderer = function(parseQueue, options){
    console.log('_html2canvas.Renderer');
...
html2canvas = function( elements, opts ) {
    console.log('_html2canvas.html2canvas');
...
_html2canvas.Renderer.Canvas = function( options ) {
    console.log('_html2canvas.Renderer.Canvas');
    ...
    console.log('_html2canvas.Renderer.Canvas - _create');
