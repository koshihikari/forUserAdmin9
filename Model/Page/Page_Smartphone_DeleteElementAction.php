...
class Page_Smartphone_DeleteElementAction extends AppModel {
	...
	public function deleteElement($request) {
		...
		// error_log("\n", 3, 'log.txt');
		// error_log("Page_Smartphone_DeleteElementAction :: deleteElement\n", 3, 'log.txt');
		...
		if ($request->isPost()) {
			...
			// error_log('leave_data_arr = ' . isset($request->data['leave_data_arr']) . "\n", 3, 'log.txt');
